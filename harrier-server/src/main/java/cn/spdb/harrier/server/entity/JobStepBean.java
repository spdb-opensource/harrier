...
public class JobStepBean implements Serializable {
	...
	public void setLogUri(URI logUri) {
		this.logUri = logUri;
	}

	public String getLogPath() {
		if (ObjectUtils.isEmpty(logUri)) {
			return "";
		}
	...
	public void setLogPath(String logPath) {
		...
		int i = logPath.indexOf("://");
		if (i >= 0) {
			logUri = URI.valueOf(logPath);
		} else {
			logUri = URI.valueOf("local:///" + logPath);
		}
	}
