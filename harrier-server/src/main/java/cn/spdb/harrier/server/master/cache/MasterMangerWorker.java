...
public class MasterMangerWorker {
	...
	public WorkingInfo getWorkerByServerName(String serverName) {
		return workingMap.searchValues(2,
				searchFunction -> searchFunction.getHost().getName().equals(serverName) ? searchFunction : null);
	}
