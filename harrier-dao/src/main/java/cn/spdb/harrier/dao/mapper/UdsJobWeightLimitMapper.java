...
public interface UdsJobWeightLimitMapper {
	...
	@ResultMap("UdsJobWeightLimitResult")
	@SelectProvider(type = SqlProviderAdapter.class, method = "select")
	List<UdsJobWeightLimit> selectManyPage(Page<UdsJobWeightLimit> page,SelectStatementProvider selectStatement); 
	default Page<UdsJobWeightLimit> selectAll(Page<UdsJobWeightLimit> page,Integer limit_type){
		...
		List<UdsJobWeightLimit> records = selectManyPage(page,selectStatement);
