...
public class UdsServer {
	...
	private ConcurrentHashMap<String, Object> paraMap = new ConcurrentHashMap<String, Object>();
	...
	public String getPara() {
		return para = JSONUtils.toJsonString(paraMap);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-03-04T10:53:06.609+08:00", comments = "Source field: uds_server.para")
	public void setPara(String para) {
		this.para = para == null ? null : para.trim();
		this.paraMap = JSONUtils.parseObject(this.para, ConcurrentHashMap.class);
	}
	...
	public void addPara(String key, Object object) {
		this.paraMap.put(key, object);
	}

	public void removePara(String key, Object object) {
		this.paraMap.remove(key);
	}
