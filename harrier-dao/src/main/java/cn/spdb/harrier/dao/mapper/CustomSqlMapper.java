...
public interface CustomSqlMapper {
    ...
    + "${selectSql}"
    + "</script>")
	List<Map<String, Object>> execSelectSqlCount(@Param("selectSql") String selectSql);
	
	default List<Map<String, Object>> execSelectCount(String selectSql){
		return execSelectSqlCount(selectSql);
	}
