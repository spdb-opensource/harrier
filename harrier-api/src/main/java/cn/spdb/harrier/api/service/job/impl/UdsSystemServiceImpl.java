...
public class UdsSystemServiceImpl implements UdsSystemService {
	...
	@Override
	public Page<UdsSystem> selectAll(Page<UdsSystem> page, String platform, String systems, String use_platform,String server_role_name_group) {
		return mapper.selectAll(page, platform, systems, null, server_role_name_group);
	}
