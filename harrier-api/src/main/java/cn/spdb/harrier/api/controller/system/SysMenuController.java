...
public class SysMenuController {
	...
	@AccessLogAnnotation(isDbInstall = true, ignoreResponse = false,ignoreRequestArgs = {"request"})
	 ...
	 * @param funcInfo 菜单
	 */
	@PostMapping(path = "/getRouters")
	public List<LoginMenu> getMenusByLogin(String userName) {
		List<LoginMenu> list = sysMenuService.menuTreeByLogin(userName);
		return list;
	}
}
