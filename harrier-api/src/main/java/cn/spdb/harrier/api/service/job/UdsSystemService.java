...
public interface UdsSystemService {
     ...
     * 应用并发设置查询(分页)
     */
    Page<UdsSystem> selectAll(Page<UdsSystem> page,String platform, String systems,Boolean usePlatform,String server_role_name_group);
    ...
    List<UdsSystem> selectAllPlatform();
}