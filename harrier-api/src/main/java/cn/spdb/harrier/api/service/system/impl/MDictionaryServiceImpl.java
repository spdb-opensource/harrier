...
public class MDictionaryServiceImpl implements MDictionaryService {
    ...
    public List<MDictionary> selectDicCode(String dicCode, String dicKey) {
        return mapper.selectDicCode(dicCode, dicKey);
    }
    
    @Override
    public Page<MDictionary> search(Page<MDictionary> page, String dicCode, String dicKey){
    	return mapper.search(page, dicCode, dicKey);
    }
