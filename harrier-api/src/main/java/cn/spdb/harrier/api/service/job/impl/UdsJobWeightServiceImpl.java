...
public class UdsJobWeightServiceImpl implements UdsJobWeightService {
	...
	@Override
	public Page<UdsJobWeight> selectAll(Page<UdsJobWeight> page, String platform, String systems, String job, Integer limitType) {
		return mapper.selectAll(page, platform, systems, job, limitType);
	}
	@Override
