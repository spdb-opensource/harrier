...
public class UdsJobRecordServiceImpl implements UdsJobRecordService {
	...
	@Override
	public Page<UdsJobRecord> selectJobRecord(Page<UdsJobRecord> page, String platform_, String system_, String job_) {
		return mapper.selectJobRecord(page, platform_, system_, job_);
	}
}