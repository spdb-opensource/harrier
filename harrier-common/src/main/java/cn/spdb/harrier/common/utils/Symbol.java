...
public interface Symbol {
	...
	/** 分号中英 */
	public static final String FEN_HAO_REG = ";|；";
	/** 冒号中英 */
	public static final String MAO_HAO_REG = ":|：";
	/** 逗号中英 */
	public static final String DOU_HAO_REG = ",|，";
	/** 分号 */
	...
	/** 单引号 */
	public static final String DAN_YING_HAO = "'";
	/** 双引号 */
	public static final String SHUANG_YING_HAO = "'";
	/** 问号 */
	public static final String WEN_HAO = "\\?";
	
	public static final String SHUANG_XIE_XIAN = "//";
	
	public static final String SHUANG_FAN_XIE_XIAN = "\\";
