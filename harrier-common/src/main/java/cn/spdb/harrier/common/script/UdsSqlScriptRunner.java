...
public class UdsSqlScriptRunner {
	...
	private StringBuffer logbuffer = new StringBuffer(256);
	...
	public UdsSqlScriptRunner(Connection connection) {
		this.connection = connection;
	}

	public UdsSqlScriptRunner(Connection connection, Logger logger) {
		this.connection = connection;
		this.logger = logger;
	}
	...
	private void print(Object o) {
		logbuffer.append(String.valueOf(o));
	}
	...
	private void println(Object o) {
		...
		if (logger != null) {
			...
			if (logWriter != null) {
				logWriter.println(logbuffer.toString());
				logWriter.flush();
			}
		}
